...
The skill generates a beautiful, zero-dependency, Catppuccin-themed HTML dashboard directly on your machine.

### 1. The Godmode Score & System Audit
Get an instant read on your environment's power level.
<img src="assets/screen-1.png" alt="Hero Dashboard showing CLI Power Score" width="100%" style="border-radius: 8px; margin: 10px 0;">

### 2. Critical Fixes & Security Scans
Catches runaway processes (like extensions burning 100% CPU) and plaintext API keys.
<img src="assets/screen-2.png" alt="Critical Fixes Section" width="100%" style="border-radius: 8px; margin: 10px 0;">
<img src="assets/screen-3.png" alt="High Impact Improvements" width="100%" style="border-radius: 8px; margin: 10px 0;">

### 3. The God-Tier Arsenal
A curated, personalized list of tools you are missing, generated based on your tech stack.
<img src="assets/screen-4.png" alt="Missing Tools Arsenal" width="100%" style="border-radius: 8px; margin: 10px 0;">

### 4. Infrastructure Mapping
Automatically maps your local ports and background proxy services (vital for local AI developers).
<img src="assets/screen-5.png" alt="System Infrastructure Map" width="100%" style="border-radius: 8px; margin: 10px 0;">
